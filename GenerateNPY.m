"""
Lit des images CT et PET, fait du resizing,normalisation, et fusion sur les images,
stocke les images et leurs labels dans des arrays différentes, réarrange les dimensions des arrays
et sauvegarde le tout dans des numpy array files (.npy)
"""
