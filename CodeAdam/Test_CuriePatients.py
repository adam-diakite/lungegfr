...
# patient_info_list = load_and_predict_median(folder_TKI, results_TKI, modelpetct1)
...
patient_info_list = load_and_predict_30(folder_TKI, results_TKI, modelpetct1)
patient_info_list_with_data = load_additional_data(csv_TKI, patient_info_list)

# kaplan_meier_analysis(patient_info_list_with_data)
# optimal_kaplan_meier(patient_info_list_with_data)
