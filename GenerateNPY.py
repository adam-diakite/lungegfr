...
ct_files = os.listdir('/home/adamdiakite/Documents/lungegfr-master/Sampledata/Images_Curie/CT')[2:]
...
for i, file in enumerate(ct_files):
    ct_path = os.path.join('/home/adamdiakite/Documents/lungegfr-master/Sampledata/Images_Curie/CT', file)
    pet_path = os.path.join('/home/adamdiakite/Documents/lungegfr-master/Sampledata/Images_Curie/PET', file)
